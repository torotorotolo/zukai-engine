...
#    🔴 2026-09-24（⑥ 試写）カズヤくん「タイトルは【映像あり】を最前に」＝旧ルール（末尾・【事故検証】の後ろ）より優先。
#       4本目サーフサイドと同じ位置。字数は変わらない（90字）。
TITLE = ("【映像あり】撃つ前の夜、高さ6キロの風は人の住む島へ向かっていた。"
         "だが後の報告書は、島の灰は雲の高い所から降ったとする。"
         "第五福竜丸の23人が被曝したビキニ水爆実験の真相【事故検証】")
...
def main() -> int:
    ...
    # ✅ 2026-09-24 カズヤくん決定＝**d**（火球の寄り＋赤「威力は 予想をはるかに超えた」＝決め所 c103）。1巡目で決まった
    thumb = "out/thumb/ep12-t1/ep12_d_iryoku_close.png"
    meta = {
        "slug": "ep12",
        "title": TITLE,
        "description": desc,
