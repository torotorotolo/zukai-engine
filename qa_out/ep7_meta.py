...
# 🔴 2026-09-14 カズヤくん決定（この2件は 2026-09-08 の「先頭に【映像あり】」を上書きする）
#   ① **`【映像あり】` はタイトルの後ろ**（先頭ではない）
#   ② **「9.11」という文字を使う**（引きが強い）。サムネの黄も同じ語に揃えた
TITLE = ("軍が1機目の乗っ取りを知らされたのは衝突9分前。残る3機は墜ちるまで知らされなかった。"
         "2,973人が亡くなった9.11アメリカ同時多発テロの真相【事故検証】【映像あり】")
