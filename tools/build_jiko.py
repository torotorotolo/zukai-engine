...
ZOOMS = [
    ...
    ("c2", 0.95, "機体-剥離範囲と5.5m", (200, 260, 720, 720)),
    ("c2", 0.95, "写真インセットと圧力差", (1250, 210, 1880, 890)),
    ("c4", 0.95, "重ね継手-段差", (260, 560, 1220, 700)),
    ("c4", 0.95, "重ね継手-亀裂", (260, 470, 1220, 620)),
    ("c4", 0.95, "情報柱-右", (1200, 320, 1880, 880)),
    ("c5", 0.95, "断面-接着層とリベット", (700, 400, 1260, 700)),
    ("c5", 0.95, "断面-外気側と客室側", (60, 210, 1880, 900)),
    # 全画面にした実写カット。**写真の上の文字が読めるか**が最大の検品点
    ("p1", 0.95, "全画面-右の注記", (1020, 260, 1900, 840)),
    ("p1", 0.95, "全画面-見出しと章", (0, 0, 1900, 300)),
    ("p2", 0.95, "全画面-左の注記", (20, 260, 900, 840)),
    ("p3", 0.95, "全画面-右の注記", (1020, 260, 1900, 840)),
    ("p4", 0.95, "全画面-左の注記", (20, 260, 900, 840)),
    ("p1", 0.95, "全画面-出典と字幕帯", (0, 830, 1900, 1080)),
    ("c7", 0.99, "数字と棒-右", (930, 260, 1840, 810)),
    ("c7", 0.99, "数字と棒-左", (90, 260, 1000, 810)),
    ("c3", 0.40, "断面-裂けていく途中", (1000, 250, 1700, 900)),
    ("c3", 0.92, "断面-客室と座席", (140, 250, 800, 900)),
    ("c5", 0.45, "断面-接着が剥がれる途中", (700, 400, 1260, 700)),
    ("c6", 0.45, "高度-折れ線を描く途中", (220, 220, 1140, 900)),
    ("c6", 0.95, "高度-右端と13分", (900, 220, 1830, 900)),
    ("c2", 0.55, "字幕-図解の上", (200, 880, 1720, 1080)),
    ("p3", 0.55, "字幕-写真の上", (200, 880, 1720, 1080)),
]
