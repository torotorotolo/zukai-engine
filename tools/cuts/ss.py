...
P016_MAP = "surfside/tf_p016_map.jpg"    # 赤黄の点の地図だけ（1920x870）
# 🔴 2026-09-06（⑤c' 直す #2・台帳 D-04）：`tf_p016_map.jpg` は 1920x1210 で、
#    下端に**凡例（c406 の主役）が入ったまま**だった。c405 は地図だけを見せるカットなのに
#    右下に凡例が字幕帯を透かして写っていた。⚠️ 凡例は原画 y 809〜1038・
#    地図の下段の矢印は y 801〜868 で**矩形の切り方（fx/fy/zoom）では分けられない**
#    ＝ファイルを切った。地図は y<870、凡例は (1240,780)-(1920,1090) を別ファイルに。
P016_LEGEND = "surfside/tf_p016_legend.jpg"   # 凡例だけ（680x310・c406）
...
#    ✅ 2026-09-06 に地図を y=870 で切ったあと**数え直して一致を確かめた**：
#       切る前の全体 赤38/黄21 ＝ 地図（y<870）赤36/黄19 ＋ 凡例（y≥870）赤2/黄2。
#       切ったあとの `tf_p016_map.jpg` でも 赤36/黄19。＝この定数は変えなくてよい。
P016_DOTS_RED = 36
P016_DOTS_YEL = 19
