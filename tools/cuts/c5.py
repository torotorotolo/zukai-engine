...
SPEC = {
    ...
    "c504": dict(
        ...
        s="本文1.2.2　昭和60年",
        fig=("panel", dict(blocks=[
            dict(k="船", c=J.INST, t="海上保安庁の測量船"),
            dict(k="船", c=J.INST, t="海洋科学技術センターの海中作業船")],
    ...
    "c507": dict(
        ...
        fig=("absent", dict(mode="single", items=[
            dict(t="残骸の一部とみられるもの", d="発見されなかった", ok=False)],
            lead="17か所すべてを撮影した結果")),
    ),
    ...
    "c512": dict(
        ...
        ann=[dict(t="トーション・ボックス", v="約900 kg", vc=J.AMBER, vs=68),
             dict(t="それでも", d="音波で見分けるには小さい", dc=J.ALERT, ds=32)],
    ),
    ...
    "c513": dict(
        ...
        fig=("moment", dict(clock="—", label="えい航式深海カメラ",
                            facts=[dict(t="問い", v="端から見ていけばよいのでは",
                                        c=J.AMBER)])),
    ),
    ...
    "c517": dict(
        ...
        fig=("absent", dict(mode="ledger", items=[
            ...
            dict(t="同じ場所の撮り直し", d="何度か繰り返す必要がある", ok=True)],
            lead="当時の深海カメラ")),
    ),
    ...
    "c522": dict(
        ...
        s="報道　2015年8月12日",
        fig=("panel", dict(blocks=[
            dict(k="報道", c=J.DOC, t="123便の部品の可能性がある物体が見つかった"),
            dict(k="日付", c=J.LINE, t="2015年8月12日に報じられた")],
    ...
    "c525": dict(
        ...
        fig=("beforeafter", dict(
            a=dict(k="1985年", t="探せなかった", lines=["分解能 1.1m × 1.3m"],
                   c=J.ALERT),
            b=dict(k="2015年", t="見つかるところまで来た", c=J.OK))),
    ),

    "c526": dict(
        t="いまも落ちたままのものがある",
        s="付図-20　相模湾等の浮遊残骸揚収場所図（解説書 表5）",
        photo="ja123/f020.jpg", panel=True, side="left", bias=0.60,
        ann=[dict(t="推定される落下物", d="補助動力装置／方向舵を動かす装置",
                  dc=J.LINE, ds=30),
             dict(t="続き", d="胴体の最後部／方向舵", dc=J.LINE, ds=30)],
    ),
    ...
    "c527": dict(
        ...
        fig=("panel", dict(blocks=[
            ...
            dict(k="○", c=J.OK, t="探す道具が、まだそこまで届いていなかった")])),
    ),

    "c528": dict(
        t="この話は終わっていない",
        s="道具は年々よくなっている",
        fig=("moment", dict(clock="—", label="道具は年々よくなっている",
                            facts=[dict(t="この話", v="終わっていない", c=J.AMBER)])),
    ),

    "c529": dict(
        t="4つの疑問を見てきた",
        s="最後に、その疑問がどこから来たのかを見る",
        fig=("panel", dict(blocks=[
