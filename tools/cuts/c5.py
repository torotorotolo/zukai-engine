...
SPEC = {
    ...
    "c522": dict(
        t="溝に貼りついて、出られない",
        s="ゴムの輪がはまる溝　記録映像より",
        # 🔴 2026-09-22 ⑤c'（10-9 の16）：8（元1546）は**額の下端に白い文字列が横に走る**。
        #    22（元1560）＝溝に収まった黒いゴムの輪の接写。ショット 20〜24（動き 0.71＝
        #    ほぼ静止）で、印も焼き込みの字も無い。c506 の新しい秒（17）とは平均差 72.8、
        #    いまの絵とは 109.7 ＝どちらとも別の絵。
        **ss.still("oring_channel", "joint", 22),
    ),
