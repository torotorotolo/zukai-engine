...
SPEC = {
    ...
    "c706": dict(
        ...
        photo=ss.page(2069), panel=True, trim=(0.08, 0.14, 0.92, 0.895),
        side="right",
    ...
    "c710": dict(
        ...
        photo=ss.page(226), panel=True, trim=(0.05, 0.16, 0.97, 0.78),
        cam=EASTWARD,
        side="right",
    ...
    # 報告書の表22（島ごとの降灰のまとめ）の上の段だけ（Utirik の行まで）。行の箱が重なる＝Utirik と Taka の中ほどで切る
    "c719": dict(
        t="島の値を測る",
        s="報告書の表22　島ごとの降灰のまとめ",
        photo=ss.page(238), panel=True, trim=(0.05, 0.13, 0.97, 0.453),
        side="right",
    ...
    "c720": dict(
        ...
        photo=ss.page(1015), panel=True, trim=(0.29, 0.13, 0.88, 0.795),
        side="right",
    ...
    "c721": dict(
        ...
        photo=ss.page(232), panel=True, trim=(0.04, 0.17, 0.99, 0.85),
        side="right",
    ...
    "c722": dict(
        ...
        photo=ss.page(243), panel=True, trim=(0.05, 0.09, 0.97, 0.735),
        side="right",
