...
SPEC = {
    ...
    "c710": dict(
        ...
        fig=("panel", dict(
            ...
            cols=1, note="※ ここは噂。次のカットから NIST の解析で答える")),
    ),

    # ── c711 土と構造の解析モデル ───────────────
    "c711": dict(
        t="NIST は、この説を名指しで検討した",
        s="地面と建物を一緒に解く計算（p185）",
    ...
    "c713": dict(
        ...
        ann=[dict(t="伝わり方", d="地面の性質しだいで、まるで変わる", dc=J.LINE, ds=30)],
    ),
