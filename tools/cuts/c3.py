# -*- coding: utf-8 -*-
"""第3章 小さな空港に、ジャンボ機が5機 c301–c322（22カット）。9本目（テネリフェ）。
...
SPEC = {
    ...
    "c308": dict(
        ...
        photo=P("laspalmas_now_09"), side="right", ann_y=356,
        **ss.kind(P("laspalmas_now_09")),
        ann=[dict(t="求めたもの", d="エンジンをかける許可", dc=J.INK_W, ds=34),
             dict(t="答え", d="許可", dc=J.OK, ds=44)],
    ),
    ...
    "c316": dict(
        ...
        fig=("graph", dict(
            ...
            marks=[dict(x=3400, y=610, t="610メートル", c=J.AMBER, anchor="end", dx=-26,
                        dy=-24),
                   dict(x=0, y=629, t="629メートル", c=J.AMBER, dx=26, dy=-24),
