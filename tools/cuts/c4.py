...
SPEC = {
    ...
    "c403": dict(
        ...
        fig=("section", dict(
            ...
            note=SEC_NOTE_POS, src="米上院の報告 PDF 14頁")),
    ),
    ...
    "c408": dict(
        ...
        fig=("panel", dict(
            ...
            note=f"{NOTE_SEN} PDF 15頁", cols=2)),
    ),
    ...
    "c410": dict(
        ...
        fig=("panel", dict(
            ...
            note=f"{NOTE_SEN} PDF 15頁・55頁・ダグラス社のSB 52-37", cols=2)),
    ),
    ...
    "c413": dict(
        ...
        fig=("panel", dict(
            ...
            note=f"{NOTE_SEN} PDF 17〜18頁・37頁", cols=2)),
    ),
    ...
    "c416": dict(
        ...
        fig=("section", dict(
            ...
            note=SEC_NOTE, src="米上院の報告 PDF 17頁")),
    ),
    ...
    "c417": dict(
        ...
        fig=("section", dict(
            ...
            note=SEC_NOTE, src="米上院の報告 PDF 18〜19頁")),
    ),
    ...
    "c419": dict(
        ...
        fig=("panel", dict(
            ...
            note=f"{NOTE_SEN} PDF 19頁", cols=2)),
    ),
    ...
    #   ⑤c'（09-25）：下を 0.6777 → 0.6523（y1608）。r07 は右下に頁の注「¹All times used herein…」の1行目だけが入り
    #   文の途中で切れていた（⑤c-2 の Q2）。y1608 は左の段の「were not in place.」（強調の文の終わり・y1579〜1606）と
    #   次の段落「As a result…」（1609〜）の間、右の段は白（1578〜1634）＝2段とも行を切らず、引用の文が完結する
    "c423": dict(
        t="設計そのものの弱点",
        s="ウィンザーの事故の報告書",
        fig=("trace", dict(
            ...
            doc="NTSB の報告（米上院の報告 PDF 17頁）の原文",
            crop=(0.11, 0.5738, 0.89, 0.6523), pre=1)),
    ),
    ...
    "c425": dict(
        ...
        fig=("panel", dict(
            ...
            note=f"{NOTE_SEN} PDF 46〜47頁", cols=2)),
    ),
    ...
    "c426": dict(
        ...
        fig=("section", dict(
            ...
            note=SEC_NOTE, src="米上院の報告 PDF 47頁・48頁")),
    ),
