...
BACKDROP = {
    ...
    # 第3章：「その亀裂は、表面の下の剥離から始まっていた」
    #   … 図18＝1号殻の端材に出た中心線の剥離。第3章は一度目の船体の章
    "c324": dict(photo="titan_f18_delam.png", bias=0.50),
    ...
    # 第6章：「甲板に載せていたものを、後ろから引くようにした」
    #   … 図4＝LARS に載ったタイタンを上から見た図。地紋が黒なので様式にも合う
    "c605": dict(photo="titan_f04_lars.png", bias=0.50),
}
