...
SPEC = {
    ...
    "ep05": dict(
        ...
        s="p191 の波括弧",
        photo=ss.P191, side="right", ann_y=330,
        # 2026-09-06（6）G-10：「understrength」「(largest, pervasive)」が左端で 130/223px 欠けていた（k=1）
        # 2026-09-06（6）G-13：焼き込みの英文が字幕帯の中に入っていた（bias を 0.06 下げて逃がす）
        xbias=0.05, bias=0.78, zoom=2.2,
    ...
    "ep07": dict(
        ...
        s="括弧の下の一文　前半（p191）",
        photo=ss.P191, side="left", ann_y=330,
        # 2026-09-06（6）G-10：原文の主語 "These" ごと左端で 147px 欠けていた（k=1）
        xbias=0.08, bias=0.94, zoom=2.6,
    ...
    "ep09": dict(
        ...
        s="括弧の下の一文　後半（p191）",
        photo=ss.P191, side="right", ann_y=330,
        # 2026-09-06（6）G-10：原文の主語 "These" ごと左端で 180px 欠けていた（k=1）
        xbias=0.10, bias=1.0, zoom=2.2,
