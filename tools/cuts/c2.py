...
SPEC = {
    ...
    "c207": dict(
        ...
        xbias=0.675, bias=0.342, zoom=1.3,   # B-05: 出典行がメモの最終行に載っていた
    ...
    "c211": dict(
        ...
        # 2026-09-06（6）G-13：焼き込みの英文が字幕帯の中に入っていた。構図を壊さない範囲で逃がす
        #   （元の focus() の値を書き下したうえで、bias/zoom だけを動かした）
        xbias=0.5, bias=0.32, zoom=2.6,   # B-08: 4行全部が写り「4inches」まで読めた。上2行だけに
    ...
    "c230": dict(
        ...
        **ss.focus(ss.P067, 0.42, 0.40, 1.25),   # B-27: 左下に c231 の主役（断面パネル）が半分写り込んでいた。
        ...
        ann=[dict(t="a / b / c", dy=40, d="たわみの深さで3段階", dc=J.AMBER, ds=32),
