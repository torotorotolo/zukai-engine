...
#   8本目の `230` `810` `916` `930` `1039` は9本目に1件も出ない＝網が空振りする。
#   9本目の時刻は `audio/narration.json` の字幕から**機械で拾った**（手で写していない）：
#     1:29／5時／6:17／7:42／9:00／13:38／14:15／16:36／16:50／16:55／16:56／16:58／
#     17:02／17:03:29／17:04:26〜17:04:58／17:05:22〜17:05:53／17:06:09〜17:06:50
#   ⚠️ 秒つきの `17:06:50` は、裸で写すと `1706:50`（報告書の書き方）になる＝上の
#      `\d{4}:\d{2}` が拾う。ここは**秒を落とした裸の4桁**（`1706`）と3桁（`742`）を拾う。
#   ⚠️ `500` は「夕方5時すぎ」。「1500メートル」の中は前の数字で、「500人」はうしろの単位で除く。
EP_TIMES = ("129", "500", "617", "742", "900", "1338", "1415", "1636", "1650", "1655",
            "1656", "1658", "1702", "1703", "1704", "1705", "1706")
