...
def selftest():
    ...
    h7 = {"zz30": dict(t="1機目", s="", ann=[dict(t="時刻", v="846")]),           # 鳴る
          "zz31": dict(t="3機目", s="", ann=[dict(t="時刻", v="0937")]),          # 鳴る
          "zz32": dict(t="4機目", s="", ann=[dict(t="時刻", v="1003")]),          # 鳴る
          "zz33": dict(t="1機目", s="", ann=[dict(t="時刻", v="8:46:40")]),       # 直した形＝黙る
          "zz34": dict(t="4機目", s="", ann=[dict(t="時刻", v="10:03:11")]),      # 黙る
          # ⚠️ 陰性対照＝同じ数字が**数量**として出るとき（誤報を出さないこと）
          "zz35": dict(t="人数", s="", ann=[dict(t="乗客", v="846人")]),          # 黙る
          "zz36": dict(t="機数", s="", ann=[dict(t="空にいた", v="4,500機")]),     # 黙る
          "zz37": dict(t="高さ", s="", ann=[dict(t="屋上", v="1003メートル")])}    # 黙る
    got7 = {c for k, c, *_ in scan(h7) if k == "H"}
    say(got7 == {"zz30", "zz31", "zz32"},
        f"陽性対照：この回の裸の時刻「846」「0937」「1003」が H で鳴り、"
        f"「8:46:40」と数量（846人・4,500機・1003メートル）は黙る（出た: {sorted(got7)}）")
